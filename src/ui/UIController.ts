export class UIController {
  ...
  constructor() {
    ...
    this.originalAudio = document.getElementById(
      "originalAudio"
    ) as HTMLAudioElement;
    this.processedAudio = document.getElementById(
      "processedAudio"
    ) as HTMLAudioElement;
  ...
  setStatus(
    message: string,
    type: "info" | "success" | "error" | "processing" = "info"
  ) {
  ...
  private async createAudioFromBuffer(
    audioBuffer: AudioBuffer
  ): Promise<string> {
